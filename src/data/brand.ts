export const brand = {
  name: 'R.ia',
  subtitle: 'microagencia',
  tagline: 'Transformación cotidiana',
  phone: '2914295409',
  whatsapp: 'https://wa.me/542914295409',
  ...
  typography: [
    ...
    },
    {
      ...
      usage: 'Títulos, brand name, datos, métricas, código',
      preview: 'R.ia · microagencia',
    },
  ],
  ...
  concepts: [
    {
      name: 'Puntos de Expansión',
      tag: 'Diagnóstico',
      symbol: '▸',
      description: 'Identificamos esas pequeñas mejoras en tu operación que, bien ubicadas, multiplican resultados sin grandes inversiones. No buscamos revoluciones, sino evoluciones que transforman.',
    },
    {
      name: 'Fricciones Invisibles',
      tag: 'Auditoría',
      symbol: '◇',
      description: 'Detectamos las trabas cotidianas que consumen tu energía sin que las registres. Esos micro-roces que ralentizan a tu equipo y que, una vez eliminados, liberan horas de trabajo.',
    },
    {
      name: 'Zonas de Desgaste',
      tag: 'Análisis',
      symbol: '◆',
      description: 'Señalamos las áreas de tu negocio que están drenando tiempo, claridad y recursos sin ser problemas visibles. Las re-diseñamos para que fluyan, no para que duelan.',
    },
    {
      name: 'Potencial Operativo',
      tag: 'Transformación',
      symbol: '⇢',
      description: 'Descubrimos la capacidad latente que ya existe en tu negocio y la convertimos en herramientas concretas. No agregamos capas, activamos lo que ya está ahí.',
    },
    {
      name: 'Procesos Regenerativos',
      tag: 'Sostenibilidad',
      symbol: '♢',
      description: 'Creamos sistemas que se mantienen solos. Que no requieren héroes todos los días. Que acompañan el crecimiento sin agotar a las personas que los operan.',
    },
    {
      name: 'Claridad de Gestión',
      tag: 'Visibilidad',
      symbol: '○',
      description: 'Te mostramos paneles simples y claros para que sepas exactamente cómo está tu negocio en cada momento. Sin ruido, sin hojas de cálculo imposibles.',
    },
    {
      name: 'Inteligencia Cotidiana',
      tag: 'Tecnología',
      symbol: '⬡',
      description: 'Aplicamos tecnología cálida que simplifica el día a día de tu equipo. Automatizaciones que entiende cualquiera y que realmente alivian la carga operativa.',
    },
    {
      name: 'Negocios Más Livianos',
      tag: 'Visión',
      symbol: '▹',
      description: 'Todo confluye en un objetivo: que tu negocio funcione mejor para vos y tu equipo. Menos saturación, menos desorden, menos carga mental. Más foco.',
    },
  ],
